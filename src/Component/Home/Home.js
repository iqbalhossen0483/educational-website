...
const Home = () => {
    ...
    return (
        <>
            <section className="grid grid-cols-2 bg-blue-500">
                <div className="flex justify-center items-center">
                    <div className="px-3">
                        <h2 className="text-5xl font-semibold">Learn new skills online with top educators</h2>
                        <p className="text-2xl mt-4">Learn 100% online with world-class universities and industry experts.</p>
                        <i className="fas fa-search absolute py-12 px-7 text-2xl text-gray-600"></i>
            ...
            <section className="px-5">
                ...
                <div className="grid md:grid-cols-4 gap-5 mt-10 mb-5">
                    {
